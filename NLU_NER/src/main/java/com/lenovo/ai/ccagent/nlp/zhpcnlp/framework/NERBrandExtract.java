...
import com.lenovo.ai.ccagent.nlp.zhpcnlp.dao.handle.brand.BrandMatchingDataHandle;
...
/**
 * @author :zhangchen
 * @createDate :2019年7月3日 下午5:45:09
 * @Email :zhangchen17@lenovo.com
 * @Description :
 **/
public class NERBrandExtract extends NERProcessing<String>{
    ...
    public String extract(String query, Map<String, List<NERResultEntity>> nerExtractResult) {
        MatchingDataHandle mdh = new BrandMatchingDataHandle();
        List<NERResultEntity> matchingResult = mdh.matchingResult(query);
        Object property = ConfigNERNameKeyLoad.NER_NAME_KEYS.get("brand");
        String key = property !=null ? property.toString() : "brand";
