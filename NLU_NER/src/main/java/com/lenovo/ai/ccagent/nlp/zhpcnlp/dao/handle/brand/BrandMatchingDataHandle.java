package com.lenovo.ai.ccagent.nlp.zhpcnlp.dao.handle.brand;
...
/**
 * @author :zhangchen
 * @createDate :2019年7月3日 下午5:39:37
 * @Email :zhangchen17@lenovo.com
 * @Description :
 **/
public class BrandMatchingDataHandle implements MatchingDataHandle{
    ...
    public List<NERResultEntity> matchingResult(String query) {
        ...
        for (String regex : NERDataCache.BRAND_REGEX) {
